...
//  }
  ...
  const color = (customerCount>0&&partnerCount===0)||((customerCount/5)>partnerCount)?"orange":"green"
  const svg = (customerCount>0&&partnerCount===0)||((customerCount/5)>partnerCount)?waitingLogo:goodLogo
  const status = (customerCount>0&&partnerCount===0)||((customerCount/5)>partnerCount)?"Help Needed Up Front":"No Help Needed"
  ...
  return (
    <div className="App" >
      ...
      <header className="App-header" style={{backgroundColor:color}}>
        <h1>{status}</h1>
        <img src={svg} className="App-logo" alt="logo" onClick={"hello"}/>
        <h3>
          Customers up front: {customerCount}
        </h3>

        <h3>
          Partners up front: {partnerCount}
        </h3>
